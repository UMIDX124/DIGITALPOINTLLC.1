      ...
      <div className="relative z-10 w-full px-5 pt-28 pb-20 sm:px-6 md:pt-32 md:pb-28">
        <div className="max-w-3xl mx-auto md:mx-0 md:ml-[12%] lg:ml-[14%]">
          ...
          >
            ...
            <span className="text-zinc-400 text-xs sm:text-sm">For companies spending $10k-$200k/month on ads</span>
          </motion.div>
          ...
          >
            <Link href="/free-growth-audit" className="w-full sm:w-auto">
              <span className="relative flex sm:inline-flex w-full sm:w-auto px-8 py-4 text-lg font-semibold text-white rounded-lg overflow-hidden group transition-all duration-200 hover:brightness-110 active:scale-[0.98] justify-center bg-violet-600">
            ...
            <Link
              href="/results"
              className="px-8 py-4 text-lg font-medium text-zinc-400 rounded-lg transition-all duration-200 hover:text-white hover:bg-white/5 block sm:inline-block text-center border border-white/10 hover:border-white/20"
            >
              See Case Studies
            </Link>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-zinc-500 text-sm mt-10 italic max-w-lg"
          >
            ...
            <span className="not-italic text-zinc-400 ml-2">&mdash; Faizan, Co-Founder</span>
          </motion.p>
