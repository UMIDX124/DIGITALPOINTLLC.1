...
faqs:
  ...
  - question: "Why does my CPA increase when I increase Facebook ad budget?"
    answer: "Increasing budget forces Meta to reach beyond your most responsive audience, which naturally includes less qualified prospects. This is expected. The key is managing the CPA increase by scaling gradually, refreshing creative, and expanding to new audiences alongside budget increases."
  - question: "What budget do I need to scale Facebook ads effectively?"
    answer: "You need a minimum of $5,000/month to begin meaningful scaling. At $10K-20K/month, you can run proper tests and scale winners. At $50K+/month, you have enough budget for comprehensive testing across multiple audiences and creative angles."
---
...
- At $50/day: Algorithm reaches your top 5% most likely converters
...
**Example scaling timeline (starting at $100/day):**
...
**Audience expansion progression:**
1. Start: 1% lookalike of purchasers
2. Next: 1% lookalike of qualified leads
3. Then: 2-3% lookalike of purchasers
4. Then: Interest-based audiences related to your product
5. Then: Broad targeting with strong creative
6. Then: International expansion (if applicable)

**How to test new audiences:**
...
**Creative expansion strategy:**
- Take your winning message and create it in new formats (if the image ad won, make a video version)
...
**Placement testing order:**
1. Facebook Feed + Instagram Feed (start here)
...
1. Duplicate the entire campaign
2. Set the duplicate at the same budget as the original
...
**ASC scaling approach:**
- Start ASC at 20-30% of your total Meta budget
...
**Week 1 (Testing Campaign):**
- Launch 4-6 new creative concepts
- Budget: $50-100/day
...
1. First: Expand within the US (if targeting specific states/metros, go nationwide)
2. Then: Canada and UK (similar market dynamics)
3. Then: Australia and Western Europe
4. Then: Other English-speaking or relevant markets
...
**Diagnosis:** Likely learning phase reset or audience saturation.
...
**Diagnosis:** Creative fatigue combined with audience saturation.

**Solution:**
- Launch 5-10 new creative variations
...
**Diagnosis:** Audience is too narrow for your budget level.

**Solution:**
- Expand lookalike percentage (1% to 2-3%)
...
3. Scales validated winners aggressively
