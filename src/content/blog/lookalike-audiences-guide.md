...
faqs:
  ...
  - question: "What size should my lookalike audience seed list be?"
    answer: "Aim for at least 1,000 contacts in your seed list, with 2,000-5,000 being ideal. Smaller lists can work but produce less stable results. Quality matters more than quantity, so a list of 1,000 high-value customers outperforms 5,000 random leads."
  - question: "Should I use 1% or broader lookalike audiences?"
    answer: "Start with 1% lookalikes for your best seed audiences (purchasers, high-value customers). Expand to 2-3% once 1% is performing well and you need more reach. Going beyond 5% typically dilutes quality too much for most advertisers."
---
...
- Approximately 75-80% of iOS users opt out of tracking
...
1. **High-value customers** - Top 20% by lifetime value
2. **Repeat purchasers** - Customers with 2+ purchases
3. **Recent converters** - Customers from the last 90 days
4. **Qualified leads** - Leads that became opportunities
5. **All customers** - Complete customer list
6. **Email subscribers** - Engaged subscribers only
7. **Pixel-based converters** - Still useful but less reliable
...
**For e-commerce:**
- Seed: Customers with AOV in the top 25%
...
**High-value stack:**
- 1% lookalike of purchasers + 1% lookalike of qualified leads + 1% lookalike of high-engagement users
...
**What still works:**
- Customer list lookalikes (especially with email + phone matching)
...
**Current options:**
- Customer Match audiences for audience expansion
...
**Effective LinkedIn lookalike strategies:**
- Upload customer email lists (matched against LinkedIn profiles)
...
**Phase 1: Seed Quality Testing (Weeks 1-2)**

Test different seed audiences against each other:
...
**Phase 2: Size Testing (Weeks 3-4)**

Take the winning seed from Phase 1 and test sizes:
- Test A: 1% lookalike
- Test B: 2% lookalike
- Test C: 3% lookalike
- Test D: 5% lookalike
...
**Phase 3: Combination Testing (Weeks 5-6)**

Test stacked approaches:
...
1. **Cost per acquisition** - Primary metric
2. **Conversion quality** - Revenue per customer, lead quality score
3. **Scale potential** - Can this audience sustain higher budgets?
4. **Consistency** - Does performance hold over 2-4 weeks?
...
1. Expand to a broader lookalike percentage (1% to 2-3%)
2. Test new seed audiences
3. Rotate into a different targeting approach for 2-4 weeks
4. Refresh all creative before relaunching
